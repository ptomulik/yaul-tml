...
/** // doc: yaul/tml/shift_left.cpp {{{
 * \file yaul/tml/shift_left.cpp
 * \example yaul/tml/shift_left.cpp
 * \brief Usage example for \ref yaul::tml::shift_left
 */ // }}}

// [Code]
#include <yaul/tml/shift_left.hpp>
