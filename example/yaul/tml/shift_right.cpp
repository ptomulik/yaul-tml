...
/** // doc: yaul/tml/shift_right.cpp {{{
 * \file yaul/tml/shift_right.cpp
 * \example yaul/tml/shift_right.cpp
 * \brief Usage example for \ref yaul::tml::shift_right
 */ // }}}

// [Code]
#include <yaul/tml/shift_right.hpp>
