...
// yaul/tml/aux_/plus.hpp

/** // doc: yaul/tml/aux_/plus.hpp {{{
 * \file yaul/tml/aux_/plus.hpp
 * \brief Implements \ref yaul::tml::plus
 */ // }}}
# ifndef YAUL_TML_AUX_PLUS_HPP
# define YAUL_TML_AUX_PLUS_HPP

#include <yaul/tml/aux_/num_op_includes.hpp>
#include <yaul/tml/integral_c/aux_/num_op_includes.hpp>

#define AUX862492_OP +
#define AUX862492_OP_NAME plus
