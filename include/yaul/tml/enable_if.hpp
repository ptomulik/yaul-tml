...
// yaul/tml/enable_if.hpp

/** // doc: yaul/tml/enable_if.hpp {{{
 * \file yaul/tml/enable_if.hpp
 * \brief Provides \ref yaul::tml::enable_if
 */ // }}}
#ifndef YAUL_TML_ENABLE_IF_HPP
#define YAUL_TML_ENABLE_IF_HPP

#include <yaul/tml/enable_if_fwd.hpp>
#include <yaul/tml/if.hpp>
#include <yaul/tml/identity.hpp>
#include <yaul/tml/empty_base.hpp>
 ...
 *
 * \par Example
 * \snippet yaul/tml/enable_if.cpp Code
 *
 */ // }}}
