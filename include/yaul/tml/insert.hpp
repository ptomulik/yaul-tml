...
/** // doc: yaul/tml/insert.hpp {{{
 * \file yaul/tml/insert.hpp
 * \brief Provides \ref yaul::tml::insert
 */ // }}}
#ifndef YAUL_TML_INSERT_HPP
#define YAUL_TML_INSERT_HPP
 ...
 *
 * \par Example
 * \snippet yaul/tml/insert.cpp Code
 *
 */ // }}}
