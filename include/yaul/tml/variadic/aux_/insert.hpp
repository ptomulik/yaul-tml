...
# ifndef YAUL_TML_VARIADIC_AUX_INSERT_HPP
# define YAUL_TML_VARIADIC_AUX_INSERT_HPP
...
#   define BOOST_PP_FILENAME_1 <yaul/tml/variadic/aux_/insert.hpp>
#   include BOOST_PP_ITERATE()

# endif // YAUL_TML_VARIADIC_AUX_INSERT_HPP
...
template <class F, class T>
  struct insert_impl<F,BOOST_PP_ITERATION(),T>
  {
    template<BOOST_PP_ENUM_PARAMS(BOOST_PP_ITERATION(), class A) BOOST_PP_COMMA_IF(BOOST_PP_GREATER(BOOST_PP_ITERATION(),0)) class... Tail >
      struct apply
        : yaul::tml::apply<F BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_ITERATION(),A), T , Tail...>
      { };
  };
